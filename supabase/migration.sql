...
DO $$ BEGIN CREATE TYPE boiler_type AS ENUM ('combi', 'system', 'regular', 'back_boiler', 'boiler', 'heat_pump', 'water_heater', 'stove', 'fire', 'other'); EXCEPTION WHEN duplicate_object THEN null; END $$;
