...
write("src/twd/templates/modernTrade.pages.ts", r"""
...
write("src/twd/stories/ModernTradePages.stories.tsx", r"""
...
print("")
print("Modern Trade page recipes and Storybook stories generated.")
print("")
print("Next commands:")
print("  pnpm build-storybook")
