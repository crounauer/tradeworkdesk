...
const WebsiteGallery = lazyRetry(() => import("@/pages/website-gallery"));
...
const AdminInvoiceLogRoute = protect(AdminInvoiceLog, ["admin", "office_staff", "bookkeeper", "accountant"]);
...
const WebsiteGalleryRoute = protectFeature(WebsiteGallery, "website_builder");
...
const MissedCallRoute = protectFeature(MissedCallSettings, "website_builder");
...
function AppRouter() {
  ...
  <Route path="/support" component={SupportTicketsRoute} />
        ...
        <Route path="/website/gallery" component={WebsiteGalleryRoute} />
