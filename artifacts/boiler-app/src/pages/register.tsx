...
export default function Register() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (session) {
        // Email confirmation not required — apply invite code immediately
        ...
        // Email confirmation required — store code to apply after verification
    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-slate-50">
      ...
      <div className="w-full max-w-md p-8 glass-panel rounded-3xl relative z-10 m-4">
        <div className="flex flex-col items-center mb-7">
          ...
          <p className="text-muted-foreground mt-1 text-sm text-center">Create your account using an invite link</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            {codeResult?.valid && (
              <p className="text-xs text-emerald-600 font-medium">
                ✓ Valid — you'll be registered as <strong>{ROLE_LABELS[codeResult.role] ?? codeResult.role}</strong>
              </p>
            )}
          ...
          <Button
            ...
            disabled={loading || !codeResult?.valid}
          >
