const r=[{slug:"how-to-go-paperless-as-a-gas-engineer",title:"How to Go Paperless as a Gas Engineer",description:"A practical guide for gas engineers ready to ditch paper records and move to digital job management. Covers Gas Safe compliance, choosing software, and getting your team on board.",author:"James Harrison",authorRole:"Gas Safe Registered Engineer & TradeWorkDesk Founder",publishedAt:"2025-09-12",updatedAt:"2026-01-15",readingTimeMinutes:7,category:"Guides",body:`Going paperless is no longer a nice-to-have for gas engineers — it's becoming essential. Between rising customer expectations, tightening compliance requirements, and the sheer hassle of managing filing cabinets full of service records, the case for digital has never been stronger.
...
Most small teams (1-5 engineers) can transition within 4-6 weeks. Larger teams may take 2-3 months for full adoption.`},{slug:"gas-safe-record-keeping-guide",title:"Gas Safe Record Keeping: What Engineers Must Know",description:"Everything gas engineers need to know about Gas Safe record keeping requirements, retention periods, and how to stay compliant during inspections.",author:"James Harrison",authorRole:"Gas Safe Registered Engineer & TradeWorkDesk Founder",publishedAt:"2025-10-03",updatedAt:"2026-02-10",readingTimeMinutes:6,category:"Compliance",body:`Record keeping is one of the most important — and most overlooked — responsibilities for Gas Safe registered engineers. Getting it wrong can result in formal warnings, conditions on your registration, or in serious cases, removal from the Gas Safe Register entirely.
...
Yes. Gas Safe Register accepts electronic records and many inspectors prefer them because they're typically more complete and easier to review.`},{slug:"best-software-for-heating-engineers",title:"Best Software for Heating Engineers in 2025",description:"A comparison of the top job management software options for heating engineers in 2025. What to look for, what to avoid, and how to choose the right platform for your business.",author:"James Harrison",authorRole:"Gas Safe Registered Engineer & TradeWorkDesk Founder",publishedAt:"2025-11-15",updatedAt:"2026-03-01",readingTimeMinutes:8,category:"Reviews",body:`Finding the right software for a heating and plumbing business isn't straightforward. Most job management platforms are built for general field service — electrical, HVAC, landscaping — and don't understand the specific needs of gas, oil, and heat pump engineers or plumbers working in the UK market.
...
Any UK-based platform should handle GDPR compliance for you, including secure data storage, data retention policies, and customer data export/deletion capabilities.`},{slug:"managing-boiler-service-contracts",title:"How to Manage Boiler Service Contracts More Efficiently",description:"Practical tips for heating companies on managing annual boiler service contracts, reducing missed appointments, and improving customer retention.",author:"James Harrison",authorRole:"Gas Safe Registered Engineer & TradeWorkDesk Founder",publishedAt:"2025-12-08",updatedAt:"2026-02-20",readingTimeMinutes:6,category:"Business",body:`Service contracts are the bread and butter of most heating engineering businesses. A well-managed contract book provides predictable revenue, keeps your engineers busy during quiet periods, and builds long-term customer relationships. But managing hundreds or thousands of annual service dates manually is where many businesses struggle.
...
Communicate price changes 3 months before renewal with a clear explanation. Increases of 3-5% annually are generally accepted without pushback if the service quality is good.`},{slug:"heat-pump-service-software",title:"Heat Pump Service Software: What to Look For",description:"As heat pumps grow in the UK, engineers need software that handles MCS compliance, commissioning records, and performance monitoring. Here's what to look for.",author:"James Harrison",authorRole:"Gas Safe Registered Engineer & TradeWorkDesk Founder",publishedAt:"2026-01-20",updatedAt:"2026-03-10",readingTimeMinutes:6,category:"Technology",body:`The UK heat pump market is growing rapidly. With the government's target to install 600,000 heat pumps per year by 2028 and the phase-out of new gas boiler installations from 2035, heating engineers who don't adapt will be left behind. But adapting isn't just about training — it's about having the right tools to manage heat pump installations and servicing.
...
The application process typically takes 4-8 weeks from submission. You'll need to have completed your training, have appropriate insurance, and demonstrate your competence through documented installations.`}];function s(e){return r.find(t=>t.slug===e)}function n(e,t=3){const o=s(e);return o?r.filter(a=>a.slug!==e).sort((a,i)=>a.category===o.category?-1:1).slice(0,t):r.slice(0,t)}export{n as a,r as b,s as g};
