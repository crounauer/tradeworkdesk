...
const SERVICE_RECORD_SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    fields: ["appliance_safe", "defects_details", "advisories"],
  },
  {
    title: "Work Summary",
...
export function generateFormPdf(
  ...
  const effectiveRecord = (() => {
    ...
    return {
      ...
      stage_two_combustion_co2: getTaggedLineValue(safetyNotes, "Stage 2 CO2"),
      stage_two_combustion_co: getTaggedLineValue(safetyNotes, "Stage 2 CO"),
      stage_two_combustion_o2: getTaggedLineValue(safetyNotes, "Stage 2 O2"),
      stage_two_combustion_temp: getTaggedLineValue(safetyNotes, "Stage 2 Flue Temp"),
      stage_two_combustion_efficiency: getTaggedLineValue(safetyNotes, "Stage 2 Efficiency"),
      stage_two_smoke_test: getTaggedLineValue(safetyNotes, "Stage 2 Smoke Test"),
      stage_two_smoke_number: getTaggedLineValue(safetyNotes, "Stage 2 Smoke Number"),
    };
  })();
