...
const SITEMAP_URLS = [
  ...
  `https://${HOST}/oil-engineer-software`,
  `https://${HOST}/heat-pump-engineer-software`,
  `https://${HOST}/plumber-software`,
  `https://${HOST}/landlord-gas-safety-software`,
  `https://${HOST}/sole-trader-software`,
  `https://${HOST}/heating-company-software`,
