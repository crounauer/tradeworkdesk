...
router.post("/jobs", requireAuth, requireTenant, requireRole("admin", "office_staff"), requirePlanFeature("job_management"), async (req: AuthenticatedRequest, res): Promise<void> => {
  ...
  if (req.tenantId) {
    // Auto-assign to the creator when there is only one active user.
...
const FORM_TABLE_MAP: Record<string, { table: string; label: string; fieldMap: Record<string, string> }> = {
  service_record: {
    ...
    fieldMap: {
      ...
      appliance_make: "Appliance Make", appliance_manufacturer_date: "Appliance Manufacturer Date",
      appliance_model: "Appliance Model", appliance_serial: "Appliance Serial",
      appliance_type: "Appliance Type", appliance_output: "Appliance Output",
      appliance_location_within_property: "Appliance Location Within Property",
      fuel_supply_type_details: "Fuel Supply Type Details", nozzle_size_fitted: "Nozzle Size",
      oil_pressure: "Pump Pressure", burner_make_model: "Burner Make / Model",
      ...
      modulation_readings: "Sapphire Modulation Readings",
      stage_two_combustion_co2: "Stage 2 CO2", stage_two_combustion_co: "Stage 2 CO",
      stage_two_combustion_o2: "Stage 2 O2", stage_two_combustion_temp: "Stage 2 Flue Temp",
      stage_two_combustion_efficiency: "Stage 2 Efficiency", stage_two_smoke_test: "Stage 2 Smoke Test",
      stage_two_smoke_number: "Stage 2 Smoke Number",
      ...
      oil_check_heat_exchanger: "Heat Exchanger",
      oil_check_combustion_chamber: "Combustion Chamber",
      oil_check_electrodes: "Electrodes",
      oil_check_oring: "O-Ring",
      oil_check_condensate: "Condensate",
      oil_check_oil_pump: "Oil Pump",
      oil_check_air_setting: "Air Setting",
      oil_check_solednoid: "Solednoid",
      oil_check_control_box: "Control Box",
      oil_check_control_panel: "Control Panel",
      oil_check_motor: "Motor",
      oil_check_prv: "PRV",
      oil_check_oil_hoses: "Oil Hose/s",
    },
  },
  breakdown_report: {
  ...
  burner_setup_record: {
    ...
    fieldMap: {
      appliance_make: "Appliance Make", appliance_model: "Appliance Model",
      appliance_serial: "Appliance Serial", appliance_type: "Appliance Type",
      appliance_location: "Appliance Location", fuel_supply_type: "Fuel Supply Type",
      appliance_installation_date: "Appliance Installation Date",
      appliance_warranty_expiry: "Appliance Warranty Expiry",
      nozzle_size: "Nozzle Size", pump_pressure: "Pump Pressure",
      appliance_notes: "Appliance Notes",
      burner_stage: "Burner Configuration",
      modulation_readings: "Sapphire Modulation Readings",
      burner_manufacturer: "Burner Manufacturer", burner_model: "Burner Model",
      burner_serial_number: "Burner Serial Number",
      nozzle_type: "Nozzle Type", nozzle_angle: "Nozzle Angle",
      pump_vacuum: "Pump Vacuum",
      ...
      stage_two_nozzle_size: "Stage 2 Nozzle Size", stage_two_pump_pressure: "Stage 2 Pump Pressure",
      stage_two_air_damper_setting: "Stage 2 Air Damper Setting", stage_two_head_setting: "Stage 2 Head Setting",
      stage_two_combustion_co2: "Stage 2 Combustion CO2", stage_two_combustion_co: "Stage 2 Combustion CO",
      stage_two_combustion_smoke: "Stage 2 Combustion Smoke", stage_two_combustion_efficiency: "Stage 2 Combustion Efficiency",
      additional_notes: "Additional Notes",
    },
  },
