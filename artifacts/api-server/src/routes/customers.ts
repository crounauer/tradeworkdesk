...
router.post("/customers", requireAuth, requireRole("admin", "office_staff"), async (req, res): Promise<void> => {
...
router.patch("/customers/:id", requireAuth, requireRole("admin", "office_staff"), async (req, res): Promise<void> => {
...
router.delete("/customers/:id", requireAuth, requireRole("admin"), async (req, res): Promise<void> => {
