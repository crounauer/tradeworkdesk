...
import dhwCylinderCommissioningRecordsRouter from "./dhw-cylinder-commissioning-records";
...
import superadminDbHousekeepingRouter from "./superadmin-db-housekeeping";
import tenantTemplatesRouter from "./tenant-templates";
...
import emailAuditRouter from "./email-audit";
...
router.use(dhwCylinderCommissioningRecordsRouter);
...
router.use(superadminDbHousekeepingRouter);
