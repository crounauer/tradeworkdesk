...
import { CreateServiceRecordBody, GetServiceRecordParams, GetServiceRecordResponse, UpdateServiceRecordParams, UpdateServiceRecordBody, UpdateServiceRecordResponse, GetServiceRecordByJobParams, GetServiceRecordByJobResponse, } from "@workspace/api-zod";
const router = Router();
...
router.post("/service-records", requireAuth, async (req, res) => {
...
router.get("/service-records/:id", requireAuth, async (req, res) => {
...
router.patch("/service-records/:id", requireAuth, async (req, res) => {
...
router.get("/service-records/job/:jobId", requireAuth, async (req, res) => {
    ...
    if (!data) {
        res.status(404).json({ error: "No service record for this job" });
        return;
    }
