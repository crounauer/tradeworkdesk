...
import { ListPropertiesQueryParams, ListPropertiesResponse, CreatePropertyBody, GetPropertyParams, GetPropertyResponse, UpdatePropertyParams, UpdatePropertyBody, UpdatePropertyResponse, DeletePropertyParams, } from "@workspace/api-zod";
const router = Router();
...
router.post("/properties", requireAuth, requireRole("admin", "office_staff"), async (req, res) => {
...
router.patch("/properties/:id", requireAuth, requireRole("admin", "office_staff"), async (req, res) => {
...
router.delete("/properties/:id", requireAuth, requireRole("admin"), async (req, res) => {
