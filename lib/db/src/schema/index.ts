...
export const boilerTypeEnum = pgEnum("boiler_type", ["combi", "system", "regular", "back_boiler", "boiler", "heat_pump", "water_heater", "stove", "fire", "other"]);
...
export const serviceRecords = pgTable("service_records", {
  ...
  appliance_serial: text("appliance_serial"),
  appliance_type: text("appliance_type"),
  appliance_location: text("appliance_location"),
  fuel_supply_type: text("fuel_supply_type"),
  burner_stage: text("burner_stage"),
  modulation_readings: text("modulation_readings"),
  appliance_installation_date: date("appliance_installation_date"),
  appliance_warranty_expiry: date("appliance_warranty_expiry"),
  appliance_next_service_due: date("appliance_next_service_due"),
  appliance_notes: text("appliance_notes"),
  ...
  stage_two_nozzle_size: text("stage_two_nozzle_size"),
  stage_two_pump_pressure: text("stage_two_pump_pressure"),
  stage_two_air_damper_setting: text("stage_two_air_damper_setting"),
  stage_two_head_setting: text("stage_two_head_setting"),
  stage_two_combustion_co2: text("stage_two_combustion_co2"),
  stage_two_combustion_co: text("stage_two_combustion_co"),
  stage_two_combustion_smoke: text("stage_two_combustion_smoke"),
  stage_two_combustion_efficiency: text("stage_two_combustion_efficiency"),
