...
export declare const JobJobType: {
 ...
 * @nullable
 */
export type ServiceRecordApplianceClassification = (typeof ServiceRecordApplianceClassification)[keyof typeof ServiceRecordApplianceClassification] | null;
export declare const ServiceRecordApplianceClassification: {
    readonly safe: "safe";
    readonly at_risk: "at_risk";
    readonly immediately_dangerous: "immediately_dangerous";
...
export type CreateJobBodyJobType = (typeof CreateJobBodyJobType)[keyof typeof CreateJobBodyJobType];
export declare const CreateJobBodyJobType: {
    readonly service: "service";
    readonly breakdown: "breakdown";
    readonly installation: "installation";
    readonly inspection: "inspection";
...
export declare const CreateJobBodyPriority: {
    readonly low: "low";
    readonly medium: "medium";
    readonly high: "high";
    readonly urgent: "urgent";
...
export type UpdateJobBodyJobType = (typeof UpdateJobBodyJobType)[keyof typeof UpdateJobBodyJobType];
export declare const UpdateJobBodyJobType: {
    readonly service: "service";
    readonly breakdown: "breakdown";
    readonly installation: "installation";
    readonly inspection: "inspection";
...
export type UpdateJobBodyStatus = (typeof UpdateJobBodyStatus)[keyof typeof UpdateJobBodyStatus];
export declare const UpdateJobBodyStatus: {
    readonly scheduled: "scheduled";
    readonly in_progress: "in_progress";
    readonly completed: "completed";
    readonly cancelled: "cancelled";
...
export type CreateServiceRecordBodyApplianceClassification = (typeof CreateServiceRecordBodyApplianceClassification)[keyof typeof CreateServiceRecordBodyApplianceClassification];
export declare const CreateServiceRecordBodyApplianceClassification: {
    readonly safe: "safe";
    readonly at_risk: "at_risk";
    readonly immediately_dangerous: "immediately_dangerous";
    readonly not_to_current_standards: "not_to_current_standards";
 ...
 * @nullable
 */
export type UpdateServiceRecordBodyApplianceClassification = (typeof UpdateServiceRecordBodyApplianceClassification)[keyof typeof UpdateServiceRecordBodyApplianceClassification] | null;
export declare const UpdateServiceRecordBodyApplianceClassification: {
    readonly safe: "safe";
    readonly at_risk: "at_risk";
    readonly immediately_dangerous: "immediately_dangerous";
    readonly not_to_current_standards: "not_to_current_standards";
...
export type CreateSignatureBodySignerType = (typeof CreateSignatureBodySignerType)[keyof typeof CreateSignatureBodySignerType];
export declare const CreateSignatureBodySignerType: {
    readonly technician: "technician";
    readonly customer: "customer";
};
